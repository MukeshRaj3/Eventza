...
function refresh_datatable_organization_amenitie(){
    ...
    if ($.fn.DataTable.isDataTable('#datatable-individual_org_amenities')) {
        $('#datatable-individual_org_amenities').DataTable().destroy();
    }

    // datatables
    tableaaa = $('#datatable-individual_org_amenities').DataTable({
        ...
        "ajax": {
            "url": base_url+"admin/individual_organization_amenitie/ajax_list",
            "type": "POST",
            "data": function (data) {
                data.Name = $('#name').val();
            }
        ...
        initComplete: function () {
            this.api().columns([0]).every(function () {
                ...
                inputTitle = $('#datatable-individual_org_amenities thead th').eq(column.index()).text();
...
$('body').on('click', '#organization-amenitie-delete-save', function(e) {
    ...
    $.ajax({
        type: "post",
        url: base_url+"admin/individual_organization_amenitie/delete",
