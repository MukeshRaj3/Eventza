...
?>
        ...
        <?php endif; ?>
         <?php       
        if ($this->router->fetch_class()== 'Organization_Category'): ?>
        <script src="<?php echo base_url($frameworks_dir . '/admin/'); ?>js/organization_category.js"></script>
        <?php endif; ?>

        <?php  if ($this->router->fetch_class()== 'individual_organization'): ?>
        <script src="<?php echo base_url($frameworks_dir.'/admin/'); ?>js/individual_organization.js"></script>
        <?php endif; ?>
        
        <script src="<?php echo base_url($frameworks_dir . '/admin/'); ?>libs/ckeditor/ckeditor.js"></script>
        <?php       
        if ($this->router->fetch_class()== 'Individual_Organization_Amenitie'): ?>
        <script src="<?php echo base_url($frameworks_dir . '/admin/'); ?>js/individual_org_amenities.js"></script>
        <?php endif; ?>
        <script type="text/javascript">
