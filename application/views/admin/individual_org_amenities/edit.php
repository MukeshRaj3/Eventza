        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <?php echo form_open(base_url('admin/individual_organization_amenitie/edit/'.$organization_amenitie->id), array('id' => 'update_party_amenitie', 'class' => 'validate-form','enctype' => 'multipart/form-data', 'onsubmit' => 'submitForm(event)')); ?>
                            <div class="row">
                                ...
                                <div class="filedContent col-12 animated zoomUp">
                                    <div class="form-group">
                                        ...
                                        <div class="map-search-box">
                                            <input id="pac-input" name="name" value="<?php echo $organization_amenitie->name; ?>" onkeydown="return event.key != 'Enter';" class="form-control search_address_box fill_up_address" type="text" placeholder="Name">
                                  ...
                                  <div class="filedContent col-12 animated zoomUp">
                                    <div class="form-group">
                                        ...
                                        <div class="map-search-box">
                                            <select class="form-control" name="org_cat_id">
                                                <option></option>
                                        <?php if(!empty($res_category)){
                                                    foreach ($res_category as $key => $value) { ?>
                                                      <option value="<?php echo $value->id ?>" <?php if($organization_amenitie->org_cat_id==$value->id){echo "selected=''";} ?>><?php echo $value->name ?></option>
                                                  <?php } } ?>
                                            </select>
                                           
                                            <div id="error" class="text-danger"><?php echo form_error('org_cat_id'); ?></div>
                                        </div>
                                    </div>
                                </div>   
                               <!--  <div class="col-12 ">
