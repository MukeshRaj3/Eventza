                             ...
                             <!--    <input type="hidden" name="name" id="name" value="<?php echo $city->name; ?>"> -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="map-search-box">
                                            <input id="pac-input" name="name" onkeydown="return event.key != 'Enter';" class="form-control search_address_box fill_up_address"  type="text" placeholder="Search Address Here" value="<?php echo $city->name; ?>">
                                ...
                                <div class="filedContent col-12 animated zoomUp">
                                    <div class="form-group">
                                        <label for="Address" class="form-label">City Full Name*</label>
                                        <div class="map-search-box">
