...
class Organization_Category_model extends CI_Model {
    ...
    var $order = array('organization_category.id' => 'desc'); // default order

    public function __construct() {
        parent::__construct();

        $this->table = 'organization_category';
    ...
    public function check_organization_category($full_name) {
    ...
    public function organization_category_details($id) {
