...
class Individual_Organization_Amenitie_model extends CI_Model {
    ...
    private function _get_datatables_query() {
        ...
        $this->db->select($this->table.'.*,'.$this->table_category.'.name as category_name');
        if ($this->input->post('Name')) {
            $this->db->like($this->table . '.name', $this->input->post('Name'));
        }
        $this->db->join($this->table_category, $this->table_category.'.id =' .$this->table.'.org_cat_id');
